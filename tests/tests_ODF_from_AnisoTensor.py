...
for k in [0.1, 0.25, 0.5, 1, 5]:
    ...
    plt.plot(phiBinc, phiODF2_theo, color=np.asarray([176, 21, 21]) / 255, lw=1, linestyle='--')
    plt.plot(phiBinc, phiODF4_theo , color=np.asarray([176, 21, 21]) / 255, lw=1)
    plt.plot(phiBinc, phiODF2, color=np.asarray([230, 100, 20]) / 255, lw=1, linestyle='--')
    plt.plot(phiBinc, phiODF4, color=np.asarray([230, 100, 20]) / 255, lw=1)
